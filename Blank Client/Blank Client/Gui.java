...
implements ActionListener, ItemListener, WindowListener
{
	...
	public void initUI()
	{
		try
		{
			...
			JMenu ClientMenu = new JMenu("Runescape");
...
for (String name : SitesButtons)
	...
	public void actionPerformed(ActionEvent evt)
	{
		...
		if (cmd != null)
		{
			...
			if (cmd.equalsIgnoreCase("Moparscape"))
			{
				launchURL("http://www.moparscape.org/smf/index.php");
				log("Loading website silabsoft.org");
			}
			...
			if (cmd.equalsIgnoreCase("Runescape"))
			{
				launchURL("http://www.runescape.com");
				log("Loading website xnxx.com");
			}
